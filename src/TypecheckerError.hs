...
showIntT = showType (Int Nothing)
showBoolT = showType (Bool Nothing)
...
instance Show TypeErrors where
    ...
    showsPrec _ (TEArrIndex t)          = showString "Array index must be " . showIntT . showNot t
    showsPrec _ (TECondtion t)          = showString "Condition must be " . showBoolT . showNot t
    showsPrec _ (TEForIter t)           = showString "For loop iterator must be " . showIntT . showNot t
    ...
    showsPrec _ (TEMainSig t1 t2)       = showString "Function 'main' should have signature " .showType t2 . showNot t1
    showsPrec _ (TEUndeclared i)        = showString "Identifier " . showType i . showString " not declared in this scope"
